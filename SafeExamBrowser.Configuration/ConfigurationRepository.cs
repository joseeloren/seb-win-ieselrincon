	...
	public class ConfigurationRepository : IConfigurationRepository
	{
		...
		public static AppSettings ReadPortalExamSettings(string path, ILogger logger)
		{
			using (var stream = File.OpenRead(path))
			{
				...
				var supported = new[] { "startURL", "allowedDisplaysMaxNumber", "hashedQuitPassword", "additionalResources", "URLFilterEnable", "URLFilterEnableContentFilter", "URLFilterRules", "pdfUrl", "browserViewMode", "showTaskBar", "browserWindowAllowMinimize", "mainBrowserWindowWidth", "mainBrowserWindowPositioning", "newBrowserWindowByLinkWidth", "newBrowserWindowByLinkPositioning" };
